...
class BodyHd extends StatefulWidget {
  final Product product;
  File newFiles;

  BodyHd({Key key, this.product}) : super(key: key);
  @override
  State<BodyHd> createState() => _BodyHdState();
}

FirebaseAuth auth = FirebaseAuth.instance;

class _BodyHdState extends State<BodyHd> {
